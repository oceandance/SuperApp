...
object DateHelper {
    private const val DEFAULT_DATE_FORMAT = "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'"
    private val serverDateFormat: SimpleDateFormat = SimpleDateFormat(DEFAULT_DATE_FORMAT, Locale.getDefault())
